...
public class TestCarry {
    ...
    public void TestLoadWhenTooFarAway(){
        ...
        ct.gas(1);
        ct.move();
        System.out.println(ct.getMovable().getx() + "  " + ct.getMovable().gety());
        System.out.println(s.getMovable().getx() + "  " + s.getMovable().gety());
        ct.stopEngine();
        ct.load(s);
